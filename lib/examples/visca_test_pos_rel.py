...
pos=cam1.send(cam1.cmd.q_ptz_pos)
print("Pos: ",pos)

print("Relative move +20 pan")
cam1.send(cam1.cmd.ptz_to_rel_position(20,0,0.5,0.5))
cam1.wait_complete()
...
cam1.send(cam1.cmd.ptz_to_rel_position(0,10,0.5,0.5))
cam1.wait_complete()
...
pos=cam1.send(cam1.cmd.q_ptz_position)
print("Pos: ",pos)
