...
pos = cam1.ptz_get_position()
print("pan,tilt=",pos)

print("Going to 0,0")
cam1.send(cam1.cmd.ptz_to_abs_position(0,0,0.5,0.5))
cam1.wait_complete()

print("tilting to -10 degrees")
cam1.send(cam1.cmd.ptz_to_abs_position(0,-10,0.5,0.5))
cam1.wait_complete()
...
cam1.send(cam1.cmd.ptz_to_abs_position(0,90,0.5,0.5))
cam1.wait_complete()

print("tilting to -28 degrees")
cam1.send(cam1.cmd.ptz_to_abs_position(0,-28,0.5,0.5))
cam1.wait_complete()

print("Panning to -175 degrees (left)")
cam1.send(cam1.cmd.ptz_to_abs_position(-175,0,0.5,0.5))
cam1.wait_complete()
...
cam1.send(cam1.cmd.ptz_to_abs_position(0,0,1,1))
cam1.wait_complete()